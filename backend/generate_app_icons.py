...
"EcoTrack" wordmark's leading glyph), drawn as flat vector shapes rather
than reused from anywhere, since nothing else in the repo is a clean square
mark at icon resolution. Three source files, per capacitor-assets'
convention:
